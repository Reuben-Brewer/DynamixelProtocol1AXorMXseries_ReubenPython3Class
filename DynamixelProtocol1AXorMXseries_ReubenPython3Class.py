...
Apache 2 License
Software Revision E, 12/31/2023
...
class DynamixelProtocol1AXorMXseries_ReubenPython3Class(Frame): #Subclass the Tkinter Frame
    ...
    def __init__(self, setup_dict): #Subclass the Tkinter Frame
        ...
        try:
            ...
            exceptions = sys.exc_info()[0]
            print("LazaFollowerBeta_ReubenPython3Class __init__: DataStreamingFrequency_CalculatedFromMainThread_LowPassFilter_ReubenPython2and3ClassObject, Exceptions: %s" % exceptions)
            traceback.print_exc()
            return
        #########################################################
        #########################################################
